...
def predict_datapoint():
    if request.method == 'GET':
        ...
        DelTime = round(pred[0])
        Distance = pred[1]
        ConfidenceScore = pred[2]
        print(f"*****************************The Delivery Time after the single prediction : {DelTime}********************")
        print(f"Confidence Score is: {ConfidenceScore}")
        
        return render_template('form.html',final_result=DelTime)
